...
thread_local GLFWmousebuttonfun   g_PrevUserCallbackMousebutton = NULL;
thread_local GLFWscrollfun        g_PrevUserCallbackScroll = NULL;
thread_local GLFWkeyfun           g_PrevUserCallbackKey = NULL;
thread_local GLFWcharfun          g_PrevUserCallbackChar = NULL;
